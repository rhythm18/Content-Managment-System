    ...
    if($cnt>0) 
        {
        ...
        else
          {
            if($ref_id=="")
            {
              $sql="insert into users(first_name,last_name,paytm,mobile,city,email,user_pass,created_at) values ('$fname','$lname','$paytm','$mobile','$city','$email','$pass','$join_date')";
            ...
            else
            {
              ...
              $sql="insert into users(ref_id,first_name,last_name,paytm,mobile,city,email,user_pass,created_at) values ('$ref_id','$fname','$lname','$paytm','$mobile','$city','$email','$pass','$join_date')";
            }
