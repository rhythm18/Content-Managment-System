...
<html>
 ...
 <?php
    ...
    <?php include("inc/latest-articles.php"); ?>

    <!-- Divider Section-->
    <?php include("inc/middle-banner.php"); ?>
    <?php include("inc/list-article.php"); ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            ...
            <p class="text-big">Get Daily Updates</p>
          </div>
          <div class="col-md-8">
            <div class="form-holder">
              <form action="subscribe.php" method="post">
                <div class="form-group">
                  ...
                  <button type="submit" name="submit" id="submit" class="submit">Subscribe</button>
                </div>
              </form>
            </div>
          </div>
