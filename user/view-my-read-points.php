...
<header class="app-header"><a class="app-header__logo" href="dashboard.php"><?php include("inc/company_name.php");?></a>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Reading Points</h1>
          <p></p>
        </div>
...
$sql="select * from user_points where pt_type='1' and user_id=".$_SESSION['user_id'];
...
while ($row=mysqli_fetch_array($rs))
{
  ...
  ?>
                    <tr>
                      ...
                      <td><?php $sql="select title from articles where art_id=".$row['art_id'];
                       $title=ReturnAnyValue($conn,$sql);
                       echo $title;?></a></td>
