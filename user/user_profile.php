...
if(isset($_POST['submit']))
{
 ...
 $sql="update users set first_name='$fname',last_name='$lname',state='$state',city='$city',paytm='$paytm',mobile='$mobile',sub_status='$sts',updated_at='$udate' where user_id=$id";
...
<div class="form-group row">
    <label for="paytm" class="control-label col-md-3">Paytm No:  </label>
    <div class="col-md-8">
    <input name="paytm" type="text" class="form-control" id="paytm" value="<?php echo $row['paytm'];?>">
  </div>
</div>
