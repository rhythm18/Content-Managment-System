...
<html lang="en">
  ...
  ?> 
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Manage Articles</h1>
          <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="add_article.php">Add Article</a></li>
        </ul>
      </div>
...
if($row['status']==0) 
  ...
  ?>
                    ...
                    ?>
                      <td><a href="view_article.php?id=<?php echo $row['art_id'];?>"><?php echo $row['title'];?></a></td>
