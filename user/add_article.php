...
$filename=$n."-".basename($_FILES["fileToUpload"]["name"]);
  ...
  $sql="insert into articles (user_id,cat_id,title,details,tags,post_date,update_date,pic1,status) values ('$id','$cid','$title','$details','$tags','$dt','$dt','$filename','2')";
...
?>
              ...
              <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
               ...
               <div class="col-md-8"> <b>** Your article must be submitted with an image **</b></div></div>
            
                <div class="form-group row">
                  <label class="control-label col-md-3"></label>
               <div class="col-md-8"> <b>** Your article will be published once admin approves it **</b></div></div>
