...
<header class="app-header"><a class="app-header__logo" href="dashboard.php"><?php include("inc/company_name.php");?></a>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Referal Points</h1>
          <p></p>
        </div>
...
$sql="select * from user_points where pt_type='3' and user_id=".$_SESSION['user_id'];
...
while ($row=mysqli_fetch_array($rs))
{
  ...
  ?>
                    <tr>
                      ...
                      <td><?php $sql="select first_name from users where ref_id=".$_SESSION['user_id'];
