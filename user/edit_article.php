    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="manage_article.php">Back</a></li>
        </ul>
      </div>
...
if (isset($_POST['submit']))
 {
  ...
  $sql="update articles set cat_id='$cid',title='$title',details='$details',tags='$tags',status='2',update_date='$dt' ".$str1." where art_id=$art_id";

  if (mysqli_query($conn,$sql))
    {
      $msg="Article updated Successfully";
      $url="manage_article.php?st=s&msg=$msg";
      gotopage($url);
    ...
    { 
        ...
        $url="manage_article.php?st=f&msg=$msg";
        gotopage($url); 
    }
